...
<img class="stats" src="../../media/data/device/reader-bookproduction/bookproduction.svg" alt="" title="">
...
![iad](../../media/data/information/speed-of-information-london/infospeed.svg) <!-- .element: style="width: 70%;" -->

--s--
## Das Physische Medium wird überflüssig

<img class="pic" src="../../media/data/device/reader-telegraph/edison_stockticker.png" alt="Börsentelegrafen" title="Börsentelegrafen">
...
![](../../media/data/device/memex/memex.jpg) <!-- .element: style="width: 60%;" -->
...
![](../../media/data/device/reader-digital-categories/mobile-tablet-desktop.svg) <!-- .element: class="pic" -->
...
![](../../media/data/device/reading-flow/reading-book.svg) <!-- .element: style="width: 70%;" -->
--s--

## Lesefluss im eBook

![](../../media/data/device/reading-flow/reading-ebook.svg) <!-- .element: style="width: 70%;" -->

--s--

## Fixes Layout

![](../../media/data/device/reading-layout/fix-layout.svg) <!-- .element: style="width: 70%;" -->
...
![](../../media/data/device/reading-layout/flow-layout.svg) <!-- .element: style="width: 70%;" -->
