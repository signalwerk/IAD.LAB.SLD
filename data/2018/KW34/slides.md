...
* Application programming interface (Schnittstelle)
  * Nachrichten nicht mehr in Echtzeit
  * Push-Benachrichtigungen nicht mehr in Echtzeit
  * Aktivität/Stats nicht mehr vorhanden
--s--
## Twitter

* 2006 gegründet
* ~3300 Angestellte
* ~335 Millionen aktive User (Juli 2018)

--s--
## User erfinden Twitter

* @-replies → 2006 community 2007 offiziell
* hashtags → 2007 community, 2009 offiziell
* to tweet → 2007 Twitterrific (App), 2008 offiziell
* retweet → 2007 community, 2009 offiziell
--s--
## Mastodon
...
* Kennt jemand den Begriff [→ Cookie Clicker](http://orteil.dashnet.org/cookieclicker/)?

--s--
## Aufgabe

* Jede studierende Person macht seinen «Cookie Clicker»
...
`let` → Variable definieren (auch `var`)
...
* Im Browser ist das DOM der geparste (interpretierte) HTML-Baum
