...
* **8:15**
* Hintergründe & (Kultur-)Techniken
* **9:15** – Mozilla employee – [**Martin Giger**](https://mozillians.org/u/freaktechnik/)
* eigenes Projekt parat machen
...
## Linux
* Linux-Kernel – über 20 Mio. Code-Zeilen (LOC)
* GNU Lizenz
* Wert [~ $14,725,449,000](https://en.wikipedia.org/wiki/Linux_kernel#Estimated_cost_to_redevelop)
* [Statistik zu Kernel Contributions](https://www.phoronix.com/scan.php?page=news_item&px=Linux-September-2018-Stats)

--s--
## Sonstige

*	FireFox – über 36 Mio. Code-Zeilen (LOC)
...
Jede Zweiergruppe nimmt ein OpenSource-Projekt und stellt der Klasse vor. Mögliche Projekte:
