...
--s--
## Werkzeug
![](./img/stroke/ambroise_noordzij.png) <!-- .element: class="pic" -->
--s--
## Achslage
...
![](./img/typesetting/102r1l.jpg) <!-- .element: class="pic" -->

B42 Bd. / Vol. 1 - fol. 102r <!-- .element: class="footer" -->
--s--
## Bleibuchstaben
![](./img/typesetting/Bleiletter.png) <!-- .element: class="pic" -->
...
![](./img/punch/counterpunch/00b26873-c494-11e3-8184-14dae9b62a82.jpg) <!-- .element: class="pic" -->
...
![](./img/typesetting/P1010771_sh.jpg) <!-- .element: class="pic" -->
--s--
## Setzmaschinen
* Monotype
* Linotype
...
![](./img/typesetting/monotype.png) <!-- .element: class="pic" -->
...
--s--
## Fotosatz
![](./img/phototypesetting/optomechanisch.png) <!-- .element: class="pic" -->

--s--
## Fotosatz

![](./img/phototypesetting/lumitype/lumitype.png) <!-- .element: class="pic" -->
--s--
## Übung
...
--s--
## Beispiel
![](./img/phototypesetting/fontform/toshi_unica.jpg) <!-- .element: class="pic" -->

--s--

## Rubbelbuchstaben (Lettraset)

![](./img/phototypesetting/lettraset/20100917SAWG_fg02a.jpg) <!-- .element: class="pic" -->
--s--

## Rubbelbuchstaben (Lettraset)

![](./img/phototypesetting/lettraset/20100917SAWG_fg03a.jpg) <!-- .element: class="pic" -->
...
--s--
## Kathodenstralröhre
![](./img/phototypesetting/crt/crt2.png) <!-- .element: class="pic" -->

--s--
## Fonts werden Digital
![](./img/phototypesetting/crt/type/pixel.jpg) <!-- .element: class="pic" -->
...
![](./img/phototypesetting/digiset/digise1.jpg) <!-- .element: class="pic" -->
--s--
## Systeme ohne Monitor
![](./img/phototypesetting/digiset/digise2.jpg) <!-- .element: class="pic" -->
--s--
## Erste WYSIWYG-Systeme

--s--
## Erste WYSIWYG-Systeme
![](./img/phototypesetting/scantext/9013683843_df249dd8b6_o.jpg) <!-- .element: class="pic" -->
--s--
## Erste WYSIWYG-Systeme
![](./img/phototypesetting/scantext/9014869362_f3b6fa1689_o.jpg) <!-- .element: class="pic" -->
--s--
## Nadeldrucker

![](./img/dot-matrix-printer/EpsonFX-2190.jpg) <!-- .element: class="pic" -->

--s--
## Prinzip
![](./img/dot-matrix-printer/Nadeldrucker_Prinzip.svg) <!-- .element: class="pic" -->
...
![](./img/ikarus/dutchtypelibrary/Index_News_Nov_1.jpg) <!-- .element: class="pic" -->
--s--
## Ikarus

* [Making Faces: Metal Type in the 21st Century](https://vimeo.com/82013261) <br> Zeitmarke: 12:15
...
--s--
## Apple und TrueType
![](./img/mac/official/retouchphoto_apple_macintosh_1984_high_res_clean-1140x640.jpg) <!-- .element: class="pic" -->
