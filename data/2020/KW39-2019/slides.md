...
![Verlinkung](./img/Linking.svg)  <!-- .element: class="pic" -->
...
![Paging von Seiten](./img/paging.svg)  <!-- .element: class="pic" -->

--s--

## Logische Einheiten

![Kategorien](./img/category.svg)  <!-- .element: class="pic" -->
...
![Unterkategorien](./img/subcategory.svg)  <!-- .element: class="pic" -->
...
![Hierarchie](./img/hyrarchy.svg)  <!-- .element: class="pic" -->
...
![Navigation getrennt](./img/navigation_spread.svg)  <!-- .element: class="pic" -->
...
![Navigation zusammen](./img/navigation_compact.svg)  <!-- .element: class="pic" -->

--s--

## Breadcrumb-Navigation (Brotkrümelnavigation)

![Breadcrumb-Navigation](./img/breadcrumb.svg)  <!-- .element: class="pic" -->


--s--
## Metanavigation

![Metanavigation](./img/meta_navigation.svg)  <!-- .element: class="pic" -->

--s--
## Metanavigation

![Metanavigation auf dem Bildschirm](./img/meta_navigation_screen.svg)  <!-- .element: class="pic" -->
...
![Timeline](./img/timeline.svg)  <!-- .element: class="pic" -->
...
![Timline Screen](./img/time_navigation.svg)  <!-- .element: class="pic" -->
