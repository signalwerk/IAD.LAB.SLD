...
- **Erhebung von Daten** <br/>Fahrrad löst Zähler aus
...
Quelle: <!-- .element: class="footer" --> [Open Knowledge Foundation](https://opendefinition.org/)
...
* Jede Person sucht einen guten/nützlichen/spannenden Datensatz 
